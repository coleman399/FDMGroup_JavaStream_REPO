public class Runner {
    public static void main(String[] args) {
        ...
        System.out.println(admin1.changePassword("password1", "password1"));
        
        System.out.println(admin1.changePassword("password20", "password20"));

        System.out.println(admin1.changePassword("password10", "password10", customer1));

        Customer.setMinCustomerPasswordLength(7);

        System.out.println(customer1.getPassword());

        System.out.println(customer1.changePassword("password1", "password1"));
        
        System.out.println(customer1.changePassword("pass", "pass"));
