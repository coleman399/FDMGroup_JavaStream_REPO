...
public class Examples {
        public static void main(String[] args) {
                ...
                // Function
                Function<Trainee, String> getTraineeFullName = trainee -> trainee.getFirstName() + " "
                                + trainee.getLastName();
                ...
                BinaryOperator<Trainee> getOldestTrainee = (firstTrainee,
                                secondTrainee) -> firstTrainee.getAge() > secondTrainee.getAge() ? firstTrainee
                                                : secondTrainee;
                ...
                // Comparator
                Comparator<Trainee> traineeGradeComparator = (firstTrainee, secondTrainee) -> firstTrainee
                                .getAverageGrade()
