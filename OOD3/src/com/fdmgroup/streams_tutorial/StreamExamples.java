...
public class StreamExamples {
        public static void main(String[] args) {
                 ...
                 */
                trainees.stream().map(trainee -> trainee.getAge()).max((age1, age2) -> age1.compareTo(age2))
                                .ifPresent(maxAge -> System.out
                                                .println("the oldest trainee is " + maxAge + "years old."));
                ...
                BinaryOperator<Trainee> traineeWithHightestGrade = (firstTrainee,
                                secondTrainee) -> firstTrainee.getAverageGrade() > secondTrainee.getAverageGrade()
                                                ? firstTrainee
                                                : secondTrainee;
                 ...
                 */
                Trainee[] baTraineesArray = Arrays.stream(traineeArray)
                                .filter(trainee -> trainee.getStream().equals("BA"))
                                .toArray(Trainee[]::new);
